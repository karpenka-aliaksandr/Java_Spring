...
public class IntegrationConfig {
    ...
    public GenericTransformer<String, String> mainTransformer() {
        return text -> {
    //какая-то логика
            return LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy_MM_dd__HH:mm:ss ")) + text;
        };
    }
    ...
    public FileWritingMessageHandler messageHandler() {
        FileWritingMessageHandler handler =
                new FileWritingMessageHandler(new File(
                        "c:/Users/Aliaksandr/Documents/GB/Java_Spring/HomeWork12/Tasks/src/main/files/"));
