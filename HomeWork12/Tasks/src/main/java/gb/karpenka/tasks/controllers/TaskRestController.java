...
import gb.karpenka.tasks.services.FileGateway;
...
public class TaskRestController {
    ...
    public Task addTask(@RequestBody Task task){
        fileGateway.writeToFile("tasks.txt", "ADD " + task.toString());
    ...
    public Task updateTaskStatus(@PathVariable Long id, @RequestBody Task task) {
        fileGateway.writeToFile("tasks.txt", "UPDATE " + task.toString());
    ...
    public void deleteTask(@PathVariable Long id){
        fileGateway.writeToFile("tasks.txt", "DELETE " + taskService.findById(id).toString());
